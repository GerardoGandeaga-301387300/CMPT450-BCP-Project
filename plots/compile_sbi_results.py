...
# print("\nEXAMPLE for sbi_bimodal:")
# pprint.pprint(RESULTS["sbi_bimodal"])
...
def create_table(file_name, size, stat):
	file_name = "./plots/sbi/{}_{}_{}.png".format(file_name, stat, size)
	fig, ax = plt.subplots()
...
plt.tight_layout()
plt.legend()
plt.savefig("./plots/sbi/benchmark_ip_hist.png", dpi=600)

# actual sbi plots
create_table("sbi", 6,  "acc")
create_table("sbi", 10, "acc")
create_table("sbi", 14, "acc")
create_table("sbi", 24, "acc")
create_table("sbi", 6,  "ipc")
create_table("sbi", 10, "ipc")
create_table("sbi", 14, "ipc")
create_table("sbi", 24, "ipc")
